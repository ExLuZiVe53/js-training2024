...
//* 1. Усі змінні потрібно оголошувати перед їх використанням
//* 2. Намагатись використовувати "const" скрізь де це можливо
//* 3. Усередині функції не змінювати змінні з зовнішніх областей видимості
